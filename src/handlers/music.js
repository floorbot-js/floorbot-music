        ...
        return Promise.allSettled([
            ...
            const embed = this.getEmbedTemplate(interaction)
                ...
                .addField('Previous Track', precedingTrack ? (
                    ...
                    `Duration: **${track.live ? '*live*' : DHMS.print(precedingTrack.duration * 1000, { limit: 2 })}**\n`
                ...
                .addField('Next Track', nextTrack ? (
                    ...
                    `Duration: **${track.live ? '*live*' : DHMS.print(nextTrack.duration * 1000, { limit: 2 })}**\n`
                ) : '*Nothing to show*', true);
